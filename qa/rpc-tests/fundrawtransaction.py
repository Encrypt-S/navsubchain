...
class RawTransactionsTest(SubChainTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid subchain address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid subchain address" in e.error['message'])

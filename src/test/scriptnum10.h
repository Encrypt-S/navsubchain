...
#ifndef SUBCHAIN_TEST_SCRIPTNUM10_H
#define SUBCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SubChain Core 0.10.0, for cross-comparison.
 */
public:

...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSubChainAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSubChainAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CSubChainAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSubChainAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSubChainAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSubChainAddress(arr[0].get_str()).Get() == demoAddress.Get());

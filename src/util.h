 ...
 */
#ifndef SUBCHAIN_UTIL_H
#define SUBCHAIN_UTIL_H
...
extern const char * const SUBCHAIN_CONF_FILENAME;
extern const char * const SUBCHAIN_PID_FILENAME;
...
{
    std::string s = strprintf("subchain-%s", name);

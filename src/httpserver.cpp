...
static void http_reject_request_cb(struct evhttp_request* req, void*)
{
    ...
    evhttp_send_error(req, HTTP_SERVUSUBAIL, NULL);
}

/** Event dispatcher thread */
static void ThreadHTTP(struct event_base* base, struct evhttp* http)
{
    RenameThread("subchain-http");
...
{
    RenameThread("subchain-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/subchain/subchain/pull/6990)

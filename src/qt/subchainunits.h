...
#ifndef SUBCHAIN_QT_SUBCHAINUNITS_H
#define SUBCHAIN_QT_SUBCHAINUNITS_H
...
/** SubChain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SubChainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SubChainUnits(QObject *parent);

    /** SubChain units.
      @note Source: https://en.subchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SUB,
...
typedef SubChainUnits::Unit SubChainUnit;

#endif // SUBCHAIN_QT_SUBCHAINUNITS_H

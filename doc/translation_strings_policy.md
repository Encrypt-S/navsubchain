...
This document provides guidelines for internationalization of the SubChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `subchain_en.ts` remains unchanged.

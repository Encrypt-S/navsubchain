...
unlocked to sign the SubChain-Qt.app bundle.
...
allowing somebody to distribute a SubChain-Qt.app or subchain-qt-setup.exe with a valid
...
that the subchain-qt.exe file inside the installer had not been tampered with.
